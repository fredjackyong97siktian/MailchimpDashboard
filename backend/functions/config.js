...
module.exports = {
    ...
    QUICKBOOK_CLIENT_ID:process.env.QUICKBOOK_CLIENT_ID,
    QUICKBOOK_CLIENT_SECRET:process.env.QUICKBOOK_CLIENT_SECRET,
    QUICKBOOK_REDIRECT_URL:process.env.QUICKBOOK_REDIRECT_URL,

    MAILCHIMP_CLIENT_ID:process.env.MAILCHIMP_CLIENT_ID,
    MAILCHIMP_CLIENT_SECRET:process.env.MAILCHIMP_CLIENT_SECRET,
    MAILCHIMP_REDIRECT_URL:process.env.MAILCHIMP_REDIRECT_URL,
}