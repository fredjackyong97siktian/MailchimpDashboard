...
export const Quickbooks :React.FC<iconSize> = ({sizeNumber}) => {
    return(
        <svg width={sizeNumber} height={sizeNumber} enable-background="new 0 0 2500 2500" viewBox="0 0 2500 2500" xmlns="http://www.w3.org/2000/svg">
